...
flags.DEFINE_string('aux_name', None, 'auxiliary data name.')
...
def main(_):
  ...
  #print('all file name vars............................')
  #print(log_dir,'log_dir')
  #print(data_file,'data_file')
  #print(data_dir, 'data_dir')
  #print(FLAGS.root_dir, 'flag root dir')
  #print(FLAGS.env_name, 'flag env_name')
  #print(FLAGS.data_name, 'flag data name') # gaussian1
  #print(FLAGS.agent_name, 'flag agent name')
  #print(sub_dir, 'sub dir')
  #print('before calling train eval offline')
